...
class ResNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.conv1 = nn.Conv2d(1, 64, kernel_size=(7, 7), stride=(1, 1), padding=(3, 3), bias=False)
        ...
        self.fc = nn.Linear(512 , num_classes)  # Adjust the input size based on your input dimensions
